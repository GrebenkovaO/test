...
# Input video paths
left_video_path = "/export/scratch/ra23mar/test/EDGS/docs/static/videos/scene_final-37 (2).mp4"   # e.g., 3DGS
right_video_path = "/export/scratch/ra23mar/test/EDGS/docs/static/videos/scene_final-38 (1).mp4" # e.g., EDGS
...
while True:
    ...
    cv2.putText(frame1, "3DGS", (30, 70), font, font_scale, color, thickness, cv2.LINE_AA)

    # Add "EDGS" top-right of right video
    text_size, _ = cv2.getTextSize("EDGS", font, font_scale, thickness)
    text_x = width - text_size[0] - 30
    cv2.putText(frame2, "EDGS", (text_x, 70), font, font_scale, color, thickness, cv2.LINE_AA)
